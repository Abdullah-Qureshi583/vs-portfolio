...
const TopHeader = () => {
  return (
    <div className="relative top-0 w-full  ">
      <div className="bg-topHeaderBgColor w-full flex justify-center items-center py-1">
        ...
        <div className="w-96 hidden md:flex text-center h-6 bg-zinc-800  border-inActiveColor rounded-sm text-sm text-inActiveText  gap-2 justify-center items-center">
